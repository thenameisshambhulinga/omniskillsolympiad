...
type AdminCommandCenterData = Awaited<
...
export default async function AdminPage() {
  ...
  const { stats, recentChallenges, recentCompetitionHistory, databaseOnline } =
    commandData;
  ...
  const onboardingPercent = getPercent(stats.onboardedUsers, stats.totalUsers);
        ...
        <AdminGlassPanel className="p-6 sm:p-7">
          ...
          <div className="mt-6 grid gap-4">
            ...
            <ActionLink
              ...
              title="Protected Test Builder"
              description="Create 30-minute tests with 40–50 validated questions."
              tone="blue"
            />
          </div>
        </AdminGlassPanel>
